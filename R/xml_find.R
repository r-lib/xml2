...
xml_find_all <- function(x, xpath, ns = x$namespace %||% character()) {
  UseMethod("xml_find_all")
}

#' @export
xml_find_all.xml_missing <- function(x, xpath, ns = x$namespace %||% character()) {
  xml_nodeset()
}

#' @export
xml_find_all.xml_node <- function(x, xpath, ns = x$namespace %||% character()) {
  nodes <- xpath_search(x$node, x$doc, xpath = xpath, nsMap = ns, num_results = Inf)
  xml_nodeset(nodes)
}

#' @export
xml_find_all.xml_nodeset <- function(x, xpath, ns = x$namespace %||% character()) {
  if (length(x) == 0)
    return(xml_nodeset())
...
#' @export
#' @rdname xml_find_all
xml_find_one <- function(x, xpath, ns = x$namespace %||% character()) {
  UseMethod("xml_find_one")
}

xml_find_one.xml_missing <- function(x, xpath, ns = x$namespace %||% character()) {
  structure(list(), class = "xml_missing")
}

#' @export
xml_find_one.xml_node <- function(x, xpath, ns = x$namespace %||% character()) {
...
#' @export
xml_find_one.xml_nodeset <- function(x, xpath, ns = x$namespace %||% character()) {
  if (length(x) == 0)
    return(xml_nodeset())
...
#' @export
#' @rdname xml_find_all
xml_find_num <- function(x, xpath, ns = x$namespace %||% character()) {
  UseMethod("xml_find_num")
}

#' @export
xml_find_num.xml_node <- function(x, xpath, ns = x$namespace %||% character()) {
...
#' @export
xml_find_num.xml_nodeset <- function(x, xpath, ns = x$namespace %||% character()) {
  if (length(x) == 0)
    return(numeric())
...
#' @export
xml_find_num.xml_missing <- function(x, xpath, ns = x$namespace %||% character()) {
   numeric(0)
}

#' @export
#' @rdname xml_find_all
xml_find_chr <- function(x, xpath, ns = x$namespace %||% character()) {
  UseMethod("xml_find_chr")
}

#' @export
xml_find_chr.xml_node <- function(x, xpath, ns = x$namespace %||% character()) {
  res <- xpath_search(x$node, x$doc, xpath = xpath, nsMap = ns, num_results = Inf)
  if (!is.character(res)) {
...
#' @export
xml_find_chr.xml_nodeset <- function(x, xpath, ns = x$namespace %||% character()) {
  if (length(x) == 0)
    return(character())
...
#' @export
xml_find_chr.xml_missing <- function(x, xpath, ns = x$namespace %||% character()) {
   character(0)
}

#' @export
#' @rdname xml_find_all
xml_find_lgl <- function(x, xpath, ns = x$namespace %||% character()) {
  UseMethod("xml_find_lgl")
}

#' @export
xml_find_lgl.xml_node <- function(x, xpath, ns = x$namespace %||% character()) {
  res <- xpath_search(x$node, x$doc, xpath = xpath, nsMap = ns, num_results = Inf)
  if (!is.logical(res)) {
...
#' @export
xml_find_lgl.xml_nodeset <- function(x, xpath, ns = x$namespace %||% character()) {
  if (length(x) == 0)
    return(logical())
...
#' @export
xml_find_lgl.xml_missing <- function(x, xpath, ns = x$namespace %||% character()) {
   logical(0)
}
