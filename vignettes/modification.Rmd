...
# Creating new nodes and documents #
```{r}
x <- xml_new_node("parent",
  xml_new_node("child1"),
  xml_new_node("child2", foo = "bar"))
# Nodes have a NULL document until they are added to a document.
x$doc

d <- xml_new_document(x)
xml_children(d)[[1]]$doc

d2 <- xml_new_document(xml_new_node("parent", xml_new_node("child1"), xml_new_node("child2", foo = "bar")))
```
