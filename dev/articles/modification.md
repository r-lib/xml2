...
[`xml_attr()`](http://xml2.r-lib.org/dev/reference/xml_attr.md) or all
at once with
[`xml_attrs()`](http://xml2.r-lib.org/dev/reference/xml_attr.md). In
both cases using `NULL` as the value will remove the attribute
completely.
...
The [`xml_remove()`](http://xml2.r-lib.org/dev/reference/xml_replace.md)
can be used to remove a node (and its children) from a tree. The default
...
#> Vcells 1164831  8.9    8388608 64.0  2656594 20.3
...
#> Vcells 1165080  8.9    8388608 64.0  2656594 20.3
```
