...
Thanks for using xml2! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/r-lib/xml2/issues/new).
...
requests](https://github.com/r-lib/xml2/issues) to make sure the bug
