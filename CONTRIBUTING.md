...
This outlines how to propose a change to xml2. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("r-lib/xml2", fork = TRUE)`.
...
of Conduct](http://xml2.r-lib.org/CODE_OF_CONDUCT.md). By contributing
